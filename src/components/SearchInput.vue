  ...
  <div class="relative">
    ...
    <div class="relative w-80">
      <input
        ...
        class="bg-background-form border border-gray-500 rounded-full px-4 pl-10 py-2 outline-none focus:border-cyan-500 w-80"
        v-model="query"
        @input="softReset"
        @keyup="performSearch"
...
export default {
  ...
  computed: {
    pages () {
      ...
      const allProjects = this.$static.allProject.edges.map(edge => edge.node);

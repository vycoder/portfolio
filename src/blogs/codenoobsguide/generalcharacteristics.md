...
“_Jack of all trades, master of none_” is usually meant to be derogatory. But, when your monolithic production software started crashing in the middle of the day where half of the team is on vacation and the company is losing money and resources as time passes, it’s the jack-of-all-trades who not only knows how the application’s code works but can also check your nginx configuration, checks your version control system for latest commits, can do a quick investigation of recent release notes of related applications for possible culprits, analyze your web processes for potential bottlenecks, understand the recent high-level architectural changes that might have contributed to the problem, and can capture as well as analyze the data from your live network. And, more important, after finding the problem, this jack-of-all-trades can create fixes along with test cases, deploy your team’s fix on the server, send out emails detailing what happened and other possible affected related systems, while suggesting high-level architectural decisions that might prevent future crashes to the whole organization, written in English, Chinese, Spanish, and five other languages.

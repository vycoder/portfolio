        ...
        <div class="container-inner mx-auto text-xl pb-4 relative">
          ...
          <div class="text-lg sm:text-lg mb-16">
            <form
              ...
              class="mb-12">
              <input class="hidden" name="bot-field" hidden/>
              ...
              <div class="w-full mb-12">
                  ...
                  <textarea id="message" rows="5" name="message" class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none appearance-none focus:border-cyan-700 mb-2 px-4 py-4" placeholder="Enter your message here." required></textarea>
              </div>
